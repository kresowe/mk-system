...
$prt_data = array("Imię/ First name: " . $application_form['name'],  
	...
	"Licencja/ UCI code: " . $application_form['license'],
	"Rodzaj licencji: " . $application_form['license_type'],
	"Adres (ulica, nr domu)/ Address (street, number): ..........................................",
	"Kod pocztowy/ Zip code: " . $application_form['zip_code'],
	"Email: " . $application_form['login'],
	"Telefon/ Phone (starting with phone country code): ...............................",
...
$pdf = new MyPDF();
$pdf->printDoc(__DIR__ . "/../../../mk_dane/zgloszenia/tresc_102016.txt", 'Formularz zgłoszeniowy');
